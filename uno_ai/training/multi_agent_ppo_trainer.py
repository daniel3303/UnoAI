    ...
    def train(self, total_timesteps: int):
        ...
        while timesteps_collected < total_timesteps:
            ...
            print(f"Update {update_count:4d} | Steps: {timesteps_collected:8,}/{total_timesteps:,} | "
                  f"Players: {self.current_num_players} ({len(self.env.opponent_config.agent_players)}A {len(self.env.opponent_config.env_players)}E {len(self.env.opponent_config.random_players)}R) | "
